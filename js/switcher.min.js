!(function (t) {
  ...
  t(".switcher-toggle").on("click", function () {
    ...
    "-202px" === e.css("right")
      ? t(e).animate({ right: "0px" }, 300).addClass("shadow")
      : t(e).animate({ right: "-202px" }, 300).removeClass("shadow"),
      "-202px" === s.css("left")
        ? t(s).animate({ left: "0px" }, 300).addClass("shadow")
        : t(s).animate({ left: "-202px" }, 300).removeClass("shadow");
  }),
